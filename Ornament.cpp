...
Ornament ChocolateShavings = {"chocolate shavings", "kilograms", 0.0f, 0.15f, 100.0f};  // Price per kg
Ornament TrufflePieces = {"truffle pieces", "kilograms", 0.0f, 0.30f, 200.0f};  // Price per kg
Ornament ChocolateDrip = {"chocolate drip", "kilograms", 0.0f, 0.25f, 150.0f};  // Price per kg

Ornament Strawberries = {"strawberries", "kilograms", 0.0f, 0.10f, 50.0f};  // Price per kg
Ornament StrawberryCream = {"strawberry cream", "kilograms", 0.0f, 0.20f, 70.0f};  // Price per kg

Ornament DarkCherries = {"dark cherries", "kilograms", 0.0f, 0.20f, 30.0f};  // Price per kg
Ornament WhippedCream = {"whipped cream", "kilograms", 0.0f, 0.30f, 50.0f};  // Price per kg

Ornament LemonSlices = {"lemon slices", "kilograms", 0.0f, 0.20f, 10.0f};  // Price per kg
Ornament LemonCream = {"lemon cream", "kilograms", 0.0f, 0.30f, 60.0f};  // Price per kg

Ornament MintLeaves = {"mint leaves", "kilograms", 0.0f, 0.02f, 30.0f};  // Price per kg

Ornament Walnuts = {"walnuts", "kilograms", 0.0f, 0.12f, 110.0f};  // Price per kg
Ornament CoffeeBeans = {"coffee beans", "kilograms", 0.0f, 0.20f, 120.0f};  // Price per kg
Ornament CoffeeCream = {"coffee cream", "kilograms", 0.0f, 0.15f, 80.0f};  // Price per kg
